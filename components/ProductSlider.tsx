...
const products = [
  {
    id: 1,
    name: "FLYSHIRT GIUBBOTTO",
    price: "$435.00",
    img: "/images/img1_1.jpg",
    hoverImg: "/images/img1_2.png"
  },
  {
    id: 2,
    name: "OSAKA 1 PINCE",
    price: "$305.00",
    img: "/images/img1_2.png",
    hoverImg: "/images/img1_3.png"
  },
  {
    id: 3,
    name: "OSAKA 1 PINCES",
    ...
    hoverImg: "/images/img1_4.png"
  },
  {
    id: 4,
    name: "FIELD JACKET",
    price: "$545.00",
    img: "/images/img1_4.png",
    hoverImg: "/images/img1_5.png"
  },
  {
    id: 5,
    name: "CHILE CARGO",
    price: "$315.00",
    img: "/images/img1_5.png",
    hoverImg: "/images/img1_1.jpg"
  },
];
        ...
        {products.map((p) => (
          <Link href={`/product/${p.id}`} key={p.id} className="product-card">
            <div className="product-image-wrapper">
              <img src={p.img} alt={p.name} className="main-image" />
              <img src={p.hoverImg} alt={p.name} className="hover-image" />
            </div>
